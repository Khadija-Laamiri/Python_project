...
class Train(ExecuteurDeTests):
    ...
    def CreerGenerateurDEchantillons(self, limit_count: int):
        ...
        return self.lecteur.load_samples('train', loop_infinitely=True,limit_count=limit_count,feature_type='power') #directory = "train"
        ...
        try:
            ...
            while not coord.should_stop():
                ...
                if is_checkpoint_step:
                    ...
                    checkpoint_path = os.path.join('train/best-weights', "speech.ckpt") #gfsrsf #fdsgsfg
